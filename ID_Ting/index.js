            ...
            html: `
                ...
                <div class="card-bottom">
                    <div class="photo-wrap">
                        <svg viewBox="0 0 100 122" xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" preserveAspectRatio="xMidYMid slice">
                            <rect width="100" height="122" fill="#d8d8d8"/>
                            <circle cx="50" cy="44" r="24" fill="#b0b0b0"/>
                            <path d="M0 122 Q0 88 50 88 Q100 88 100 122Z" fill="#b0b0b0"/>
                        </svg>
                    </div>
                    <div class="id-fields">
